...
<html lang="en">
	...
	<head>
		...
		<link href="assets/Metronic-Theme/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
		<!--end::Page Vendor Stylesheets-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<link href="assets/Metronic-Theme/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
		<link href="assets/Metronic-Theme/css/style.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												<div class="menu-item">
													<a class="menu-link active" href="../../demo1/dist/apps/ecommerce/reports/view.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
																...
																<div class="menu-sub menu-sub-accordion">
																	<div class="menu-item">
																		<a class="menu-link active py-3" href="../../demo1/dist/apps/ecommerce/reports/view.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																			<span class="menu-title">Products Viewed</span>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Products Viewed Report</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Products Viewed</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="m-0">
										...
										<!--end::Menu toggle-->
										<!--begin::Menu 1-->
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6220ed84b0101">
											<!--begin::Header-->
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												...
												<div class="mb-10">
													...
													<!--begin::Input-->
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6220ed84b0101" data-allow-clear="true">
															<option></option>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
											...
											<tbody class="fw-bold text-gray-600">
												...
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03130005</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">17.276%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04339004</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">13.6108%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01673004</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">15.45864%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01106005</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-4" data-filter="rating-4">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">7.94691%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04263001</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">4.59753%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03735008</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">3.67802%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02490002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">2.94242%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01683002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">2.35394%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04873002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">1.88315%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02487007</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">1.50652%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04309002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">1.20521%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04800006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.96417%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02652004</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-3" data-filter="rating-3">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.77134%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01908003</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.61707%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04920006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.49366%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04651007</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.39492%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02133002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.31594%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03893006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-4" data-filter="rating-4">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.25275%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01333003</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.2022%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.16176%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03131002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-4" data-filter="rating-4">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.12941%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03718001</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.10353%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01565002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.08282%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02494006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.06626%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01287007</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.05301%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02918006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.0424%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04354006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.03392%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04147004</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.02714%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03669003</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-3" data-filter="rating-3">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.02171%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03664001</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-3" data-filter="rating-3">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.01737%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04936006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.0139%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03798008</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-3" data-filter="rating-3">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.01112%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04509001</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00889%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02280002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00711%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03672004</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00569%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01327009</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-2" data-filter="rating-2">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00455%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">04906003</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-3" data-filter="rating-3">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00364%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01909003</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00291%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02984001</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00233%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03938004</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00186%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02417006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00149%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02400006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00119%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02378001</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00095%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">02247002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-3" data-filter="rating-3">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00076%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03446002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00061%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03299006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-3" data-filter="rating-3">
													...
													<!--end::Viewed=-->
													<!--begin::Percent=-->
													<td class="text-end pe-0">0.00049%</td>
													<!--end::Percent=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03467006</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-1" data-filter="rating-1">
												...
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">03919002</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-5" data-filter="rating-5">
												...
												<tr>
													...
													<!--begin::SKU=-->
													<td class="text-end pe-0">
														<span class="fw-bolder">01402009</span>
													</td>
													<!--end::SKU=-->
													<!--begin::Rating-->
													<td class="text-end pe-0" data-order="rating-4" data-filter="rating-4">
		...
		<script src="assets/Metronic-Theme/plugins/global/plugins.bundle.js"></script>
		<script src="assets/Metronic-Theme/js/scripts.bundle.js"></script>
		<!--end::Global Javascript Bundle-->
		<!--begin::Page Vendors Javascript(used by this page)-->
		<script src="assets/Metronic-Theme/plugins/custom/datatables/datatables.bundle.js"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{asset('assets/Metronic-Theme/js/custom/apps/ecommerce/reports/views/views.js')}}"></script>
		<script src="assets/Metronic-Theme/js/widgets.bundle.js"></script>
		<script src="assets/Metronic-Theme/js/custom/widgets.js"></script>
		<script src="assets/Metronic-Theme/js/custom/apps/chat/chat.js"></script>
		<script src="assets/Metronic-Theme/js/custom/utilities/modals/upgrade-plan.js"></script>
		<script src="assets/Metronic-Theme/js/custom/utilities/modals/create-app.js"></script>
		<script src="assets/Metronic-Theme/js/custom/utilities/modals/users-search.js"></script>
