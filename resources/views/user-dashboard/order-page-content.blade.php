                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-end min-w-100px">Bestelldatum</th>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <!--begin::Price=-->
                            <td class="text-end pe-0">
                                <span class="fw-bolder">{{$order->payment_status?'Paid' : 'Unpaid'}}</span>
                            </td>
                            <!--end::Price=-->
                            <!--begin::Viewed=-->
                            <td class="text-end pe-0">
                            ...
                            <td class="text-end pe-0">
                                ...
                                <form action="{{route('user.sub-orders.view')}}" method="post">
                                    @csrf
                                  <button type="submit" class="btn btn-primary btn-sm" name="order_id" value="{{$order->id}}">Einzelheiten</button>
                                </form>
                                </div>
