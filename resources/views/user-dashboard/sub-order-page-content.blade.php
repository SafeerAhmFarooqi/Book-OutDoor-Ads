                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            <th class="min-w-150px">Nein</th>
                            <th class="text-start min-w-100px">Auftragsnummer</th>
                            <th class="text-end min-w-70px">Anfangsdatum</th>
                            <th class="text-end min-w-70px">Endtermin</th>
                            <th class="text-end min-w-100px">Tage</th>
