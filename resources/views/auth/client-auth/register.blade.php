...
@section('content')
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 col-md-6 col-lg-6">
                    ...
                    <p class="log-info-text">Gain access for the rental LED experience</p>
                        <a href="{{route('client.login')}}" ><p class="log-forgot-text" style="margin:0 !important">Already Have Account ? Log in </p></a>
    ...
    @if ($errors->any())
                    ...
                    <div class="col-sm-6 form-group">
                        <label>Company Name</label> <input class="cp-input-form"   type="text" placeholder="" name="company" value="{{old('company')}}" >
                          @error('company')
                        <div class="alert alert-danger">
                                {{$message}}
                        </div>
                    ...
                    <div class="col-sm-6 form-group">
                        <label>Postal Code</label> <input class="cp-input-form" id="name" type="text" placeholder="" name="postal_code" value="{{old('postal_code')}}" >
                          @error('postal_code')
                        <div class="alert alert-danger">
                                {{$message}}
                        </div>
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <a href="{{route('client.login')}}" ><p class="log-forgot-text" >Already Have Account ? Log in </p></a>
  </div></form>
