<div>
  ...
  <div class="row">
    <div class="col-sm-10">
        <a href="{{route('find.led')}}" title="Previous Page">
          <img src="{{asset('assets/images/previous-page.png')}}" style="width:50%;margin-top:50px">
        </a>
    </div>
  </div>
                </div>
...
rangeSlider.noUiSlider.on('update', function(values, handle) {
  @this.set('minPriceRange',  moneyFormat.from(
    values[0]));
    @this.set('maxPriceRange',  moneyFormat.from(
    values[1]));
