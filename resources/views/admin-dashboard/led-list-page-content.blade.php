                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                ...
                                <form action="{{route('admin.led.list.delete')}}" method="post">
                                    @csrf
                                  <button title="Löschen" type="submit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" name="led_id" value="{{$led->id}}">  <span class="svg-icon svg-icon-3">
