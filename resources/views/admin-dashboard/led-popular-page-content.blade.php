                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0"><div>{{$led->created_at->format('F d, Y')}}<br></div>
                                ...
                                <form action="{{route('admin.led.add.popular')}}" method="post">
                                    @csrf
                                  <button type="submit" class="btn btn-primary" name="led_id" value="{{$led->id}}">Popular</button>
                                </form>
                                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-0">
                                    ...
                                    <form action="{{route('admin.led.remove.popular')}}" method="post">
                                        @csrf
                                      <button type="submit" class="btn btn-danger" name="led_id" value="{{$led->id}}">Remove from Popular</button>
                                    </form>
                                    </div>
