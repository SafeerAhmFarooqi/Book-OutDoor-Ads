                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0"> 
                                ...
                                <form action="{{route('admin.led.add.popular')}}" method="post">
                                    @csrf
                                  <button type="submit" class="badge badge-light-primary fs-8 fw-bold my-2" name="led_id" value="{{$led->id}}" style="border:none">Popular</button>
                                </form>
                                </div>
