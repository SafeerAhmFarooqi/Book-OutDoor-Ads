                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="text-start min-w-100px">LED Information </th>
                            <th class="text-start min-w-100px">Käuferin Information</th>
                            <th class="text-start min-w-100px">Payment</th> 
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="text-start pe-0">
                                <span class="fw-bolder">{{$order->id}}</span><Br>    
                                <span style="font-size:10px">{{$order->created_at->format('F d, Y')}}</span>
                            </td>
             
                            <td class="text-start pe-0">
                                <span>led title here </span>
                            </td>
                            <td class="text-start pe-0">
                                <span> buyer name <br> buyer email <Br>buyer phone </span>
                            </td>

                            <td class="text-start pe-0">
                                <span>   payment : 1232 <br> comission : 32 <br> Total payment : <b class="badge badge-light-danger fs-8 fw-bold my-2" > 343 </b> </span>
                            </td>
                            ...
                            <td class="text-start pe-0">
                                    ...
                                    <a   href="javascript:;" class="badge badge-light-warning fs-8 fw-bold my-2"  title="View Order Details" type="reset" data-bs-toggle="modal" data-bs-target="#kt_modal_details_{{$order->id}}" style="border:none"> More Details </a><br>

                                  <button type="submit"  class="badge badge-light-danger fs-8 fw-bold my-2"   title="Change Status to UnPaid"   type="reset" data-bs-toggle="modal" data-bs-target="#kt_modal_unpaid_{{$order->id}}" style="border:none"> Unpaid Payment </button><br>

                                  <button type="submit"   class="badge badge-light-success fs-8 fw-bold my-2"  name="user_id" value="{{$user->id??''}}"   title="Change Status to Paid"  type="reset" data-bs-toggle="modal" data-bs-target="#kt_modal_paid_{{$order->id}}" style="border:none"> Payment Complete </button>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title">Bestellinformationen : {{$order->id}}	</h3>
                                        ...
                                        @foreach ($order->subOrders as $subOrder)
                                                       ...
                                                       <p>Pries  : {{$subOrder->price??''}} €</p>
                                                       <p>Die Summe an Tagen : {{$subOrder->no_of_days??''}}</p>
                                                       <p>Anfangsdatum  : {{$subOrder->startDate->format('F d, Y')??''}}</p>
                                                       <p>Endtermin  : {{$subOrder->endDate->format('F d, Y')??''}}</p>
                                                       <p>Datum : {{$subOrder->created_at->format('F d, Y')??''}}</p>
                                                    </div>
                                                       @endif
                                                        @endforeach
                        ...
                        <div class="modal fade" tabindex="-1" id="kt_modal_unpaid_{{$order->id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Möchten Sie den Status wirklich auf Unbezahlt ändern?  </p>
                                    </div>
                        ...
                        <div class="modal fade" tabindex="-1" id="kt_modal_paid_{{$order->id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Möchten Sie den Status wirklich auf Bezahlt ändern? </p>
                                    </div>
