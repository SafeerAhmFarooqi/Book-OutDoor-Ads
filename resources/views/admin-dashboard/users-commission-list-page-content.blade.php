            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                <div class="rating justify-content-end">
                                    ...
                                    <button class="btn btn-primary btn-active-light-primary me-2" type="reset" style="font-size:8px;" data-bs-toggle="modal" data-bs-target="#kt_modal_update_{{$user->id}}">Set Commission</button> 
                        ...
                        <div class="modal fade" tabindex="-1" id="kt_modal_update_{{$user->id}}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('admin.billing.update',[  $user->id ])}}" method="POST">
                                        @csrf
                                        @method('put')
                                        <div class="modal-body">
                                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                                                <input class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" name="admincommission" placeholder="Set Admin Commission" type="text" value="{{$user->admincommission}}">
