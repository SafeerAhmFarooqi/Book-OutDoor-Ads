    ...
    <div class="row gy-5 g-xl-10">
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-body p-9">
                        <div class="fs-4 fw-bold text-gray-600 mb-7">Led's</div>
                        <div class="fs-2hx fw-bolder">{{$ledCount}}</div>
                    </div>
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-5"> 
                    <div class="card-body p-9">
                        <div class="fs-4 fw-bold text-gray-600 mb-7">Popular Led's</div>
                        <div class="fs-2hx fw-bolder">{{$popularLedCount}}</div>
                    </div>
                    <div class="card-toolbar">   
                    </div>  
                </div>
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-header pt-5"> 
                    <div class="card-body p-9">
                        <div class="fs-4 fw-bold text-gray-600 mb-7">Trending Led's</div>
                        <div class="fs-2hx fw-bolder">{{$trendingLedCount}}</div>
                    </div>
                    <div class="card-toolbar">   
                    </div>  
                </div>
