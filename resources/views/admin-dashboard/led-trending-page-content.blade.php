                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                ...
                                <form action="{{route('admin.led.add.trending')}}" method="post">
                                    @csrf
                                  <button type="submit" class="badge badge-light-primary fs-8 fw-bold my-2"  name="led_id" value="{{$led->id}}" style="border:none">Zu Trend hinzufügen</button>
                                </form>
                                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-0">
                                    ...
                                    <form action="{{route('admin.led.remove.trending')}}" method="post">
                                        @csrf
                                      <button type="submit" class="badge badge-light-danger fs-8 fw-bold my-2"  value="{{$led->id}}" style="border:none">Aus Trending entfernen </button>
                                    </form>
                                    </div>
