                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0">
                                ...
                                <form action="{{route('admin.led.add.trending')}}" method="post">
                                    @csrf
                                  <button type="submit" class="btn btn-primary btn-sm" name="led_id" value="{{$led->id}}">Add to Trending</button>
                                </form>
                                </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-0">
                                    ...
                                    <form action="{{route('admin.led.remove.trending')}}" method="post">
                                        @csrf
                                      <button type="submit" class="btn btn-danger" name="led_id" value="{{$led->id}}">Remove from Trending</button>
                                    </form>
                                    </div>
