        ...
        <div class="card card-flush">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <div class="w-150px">
                        <!--begin::Select2-->
                        <a href="{{route('client.led.add')}}" class="btn btn-primary">Neue LED hinzufügen</a>
                        <!--end::Select2-->
                    </div>
                    <!--end::Filter-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_views_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            <th class="min-w-50px">Nein</th>  
                            <th class="min-w-350px">Titel</th>
                            <th class="text-end min-w-100px">Preis</th>
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-0" style="">
                               <a class="btn btn-primary btn-xs" href="{{route('client.led.edit',$led->id)}}">&nbsp;  Bearbeiten  &nbsp; &nbsp; </a> <Br> 
                                <form action="{{route('client.led.view.delete')}}" method="post" style="margin-top:3px">
                                    @csrf
