                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                <textarea class="form-control form-control-lg form-control-solid" name="description" value="{{old('description')?old('description') : $led->description}}" placeholder="Description">{{old('description')?old('description') : $led->description}}</textarea>
                                @error('description')
                                <div class="alert alert-danger">
                                        {{$message}}
                                </div>
                        ...
                        {{-- <div class="row mb-6">
                            <!--begin::Label-->
                            <label class="col-lg-4 col-form-label fw-bold fs-6"><Title></Title></label>
                            <!--end::Label-->
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                ...
                <div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-header align-items-center border-0 mt-4">
                        ...
                        {{-- <div class="card-toolbar">
                            ...
                            <!--begin::Menu 1-->
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6220ee32efce4">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6220ee32efce4" data-allow-clear="true">
                                                <option></option>
