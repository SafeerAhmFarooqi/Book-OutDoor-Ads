...
<div class="site-blocks-cover inner-page-cover overlay aos-init aos-animate" style="background-image: url({{asset('assets/Led-Theme/images/hero_2.jpg')}});max-height: 100px !important; min-height: 150px !important;" data-aos="fade" data-stellar-background-ratio="0.5">
  ...
  <div class="site-section" data-aos="fade">
    <div class="container" style="padding-top:100px;padding-bottom: 100px;font-family: calibri;font-style: justify">
       ...
       <p> Diese Datenschutzerklärung klärt Nutzer über die Art, den Umfang und Zwecke der Erhebung und Verwendung personenbezogener Daten durch den verantwortlichen Anbieter, Emotions Personal Ems UG Haftungsbeschränkt &amp; Co. KG, Löhrstraße 87a 56068 Koblenz- Vertreten durch Uwe Hochhalter info@ed-werbeflaechen.de, +49-(0)2612 0069568 auf dieser Website (im folgenden “Angebot”) auf. </p>
       ...
       <p> Vom Websiteinhaber angepasst: Datenschutz-Muster von Rechtsanwalt Thomas Schwenke – I LAW it </p>
